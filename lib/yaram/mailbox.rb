...
module Yaram
  class Mailbox
    ...
    # A mailbox is open if it is bound and ready to recieve, or connected and the other side is ready to receive.
    # @return [Boolean]
    def open?
      # If we are bound then we are an inbox and open by default
      return true if bound?
      #raise NotImplementedError, "bound mailbox classes need to implement their own open? check"
